...
public class Exception09 {
	...
	public static void main(String[] args) {
		...
		//throw is used with new keyword inside any {}  body/codeblock and single use
		//throws is after method signature with comma separated for multiple
	...
	public class E09 {
		...
		/*
		 ...
		 3)"throw" keyword is used to throw Exception explicitly whereever we want, "throws"
